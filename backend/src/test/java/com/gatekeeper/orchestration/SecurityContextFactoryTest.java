...
class SecurityContextFactoryTest {
    ...
    private final SecurityContextFactory factory = new SecurityContextFactory();
    ...
    void build_extractsOnlyAddedLinesFromThePatchWithThePrefixStripped() {
        ...
        SecurityContext context = factory.build(run, List.of(new GitHubFileChange("src/Foo.java", "modified", 3, patch)));
    ...
    void build_excludesTheDiffFileHeaderLineEvenThoughItStartsWithPlusPlusPlus() {
        ...
        SecurityContext context = factory.build(analysisRun(1L, "org/repo"),
    ...
    void build_handlesMultipleFilesAndMultipleHunksInOnePatch() {
        ...
        SecurityContext context = factory.build(analysisRun(1L, "org/repo"), List.of(
