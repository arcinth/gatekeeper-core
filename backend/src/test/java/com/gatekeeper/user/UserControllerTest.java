...
/**
 * Proves USER_MANAGE gates every method on this controller (Milestone 5:
 * RBAC Enforcement) - business logic itself belongs to UserService; this
...
class UserControllerTest {
    ...
    void findAll_returns403WhenTheCallerIsADeveloper() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/users").header("Authorization", "Bearer test-token"))
                .andExpect(status().isForbidden());
    }

    @Test
    void findAll_returns200WhenTheCallerHasUserManage() throws Exception {
        authenticateAs("admin@example.com", "ROLE_ADMINISTRATOR", "WORKSPACE_READ", "USER_MANAGE");
